...
def sidebar():
    ...
    return Nav(
        Div(
            ...
            # Manage section
            _sidebar_section("Manage"),
            Div(
                *[_sidebar_link(label, href, icon) for label, href, icon in manage_items],
                cls="flex flex-col",
            ),
            # System section
